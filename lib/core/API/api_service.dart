...
@lazySingleton
//live api
@RestApi(baseUrl: 'https://apiv2stg.promilo.com/')
abstract class ApiService {
  ...
  Future<LoginResponseModel> login(@Query("username") String username, @Query("password") String password, @Query("grant_type") String type);
